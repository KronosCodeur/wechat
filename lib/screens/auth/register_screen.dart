      ...
      if (checkPassword(_userPassword) && checkPasswordLength(_userPassword)) {
        ...
        await authService
            .registerUserWithEmailandPassword(
                _userFullName, _userMail, _userPassword)
            .then((value) async {
          if (value == true) {
            ...
            Navigator.pushNamed(context, "/login");
            showSnackbar(context,"You are successfully registered", GoogleFonts.poppins(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w500,), CupertinoColors.activeGreen);
          } else {
            setState(() {
              _isLoading = false;
            });
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                'Le mot de passe doit contenir des caractères spéciaux et doit etre supérieur a 8 caractères',
                style: GoogleFonts.poppins(
